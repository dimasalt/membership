...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf32 COLLATE=utf32_unicode_ci COMMENT='holds information relevant to program purchaces such as price and other things';
...
-- Dumping data for table membership.logs: ~5 rows (approximately)
DELETE FROM `logs`;
/*!40000 ALTER TABLE `logs` DISABLE KEYS */;
INSERT INTO `logs` (`id`, `username`, `page`, `action`, `agent`, `ip`, `created_at`) VALUES
	(59, 'dmitri@better-life-tips.com', 'Logout', 'logged out', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36', '38.122.184.202', '2017-03-30 19:02:15'),
	(60, 'dmitri@better-life-tips.com', 'Login Page', 'login', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36', '38.122.184.202', '2017-04-10 17:30:38'),
	(61, 'dmitri@better-life-tips.com', 'Logout', 'logged out', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36', '38.122.184.202', '2017-04-10 17:30:45'),
	(62, 'dmitri@better-life-tips.com', 'Login Page', 'login', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36', '38.122.184.202', '2017-04-11 13:37:18'),
	(63, 'dmitri@better-life-tips.com', 'Logout', 'logged out', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36', '38.122.184.202', '2017-04-11 13:37:39'),
	(64, 'dmitri@better-life-tips.com', 'Login Page', 'login', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36', '38.122.184.202', '2017-04-27 15:15:09'),
	(65, 'dmitri@better-life-tips.com', 'Logout', 'logged out', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36', '38.122.184.202', '2017-04-27 15:16:56'),
	(66, 'dmitri@better-life-tips.com', 'Login Page', 'login', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36', '38.122.184.202', '2017-04-27 15:17:05'),
	(67, 'dmitri@better-life-tips.com', 'Logout', 'logged out', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36', '38.122.184.202', '2017-04-27 15:17:21');
...
INSERT INTO `programs` (`program_id`, `name`, `full_name`, `excert`, `program_img`, `sales_url`, `is_published`, `is_free`, `place`, `updated_at`, `created_at`) VALUES
	(1, 'Meditation: A Complete Guide', 'Meditation: A Complete Guide From A to Z', 'Your one-stop meditation reference. A step-by-step guide with all the theory and practice you need to successfully learn and master meditation and harvest it power into your life.', '/assets/images/meditation-guide.png', '/sp/2', 1, 0, 1, '2017-07-18 18:05:38', '2016-05-04 22:55:16'),
...
-- Dumping data for table membership.program_items: ~0 rows (approximately)
...
-- Dumping data for table membership.program_items_category: ~0 rows (approximately)
...
-- Dumping data for table membership.program_item_files: ~0 rows (approximately)
...
INSERT INTO `program_item_files` (`file_id`, `item_id`, `folder`, `file`, `name`, `type`, `place`, `created_at`) VALUES
	(1, 1, 'meditation a complete guide from a to z', '1. Welcome.pdf', 'Welcome.pdf', 'pdf', 2, '2016-05-13 08:29:21'),
	(2, 2, 'meditation a complete guide from a to z', '2. Why meditation and what you need to succeed.pdf', 'Why meditation and what you need to succeed.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(3, 3, 'meditation a complete guide from a to z', '3. Benefits of meditaiton.pdf', 'Benefits of meditaiton.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(4, 4, 'meditation a complete guide from a to z', '4. Your practice diet.pdf', 'Your practice diet.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(5, 5, 'meditation a complete guide from a to z', '5. Positions for meditation.pdf', 'Positions for meditation.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(7, 7, 'meditation a complete guide from a to z', '6. Breathing Theory.pdf', 'Breathing Theory.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(8, 8, 'meditation a complete guide from a to z', '6.1 Basic breathing practice.pdf', 'Basic breathing practice.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(9, 9, 'meditation a complete guide from a to z', '6.2 Working with nadi channels.pdf', 'Working with nadi channels.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(10, 10, 'meditation a complete guide from a to z', '6.3 Grounding breathing technique.pdf', 'Grounding breathing technique.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(11, 6, 'meditation a complete guide from a to z', '7. Relaxation.pdf', 'Relaxation.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(12, 11, 'meditation a complete guide from a to z', '8. Concentration.pdf', 'Concentration.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(13, 12, 'meditation a complete guide from a to z', '8.1 Two techniques for concentration.pdf', 'Two techniques for concentration.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(14, 13, 'meditation a complete guide from a to z', '9. Meditation theory.pdf', 'Meditation theory.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(15, 14, 'meditation a complete guide from a to z', '9.1 Mindfulness meditation.pdf', 'Mindfulness meditation.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(16, 15, 'meditation a complete guide from a to z', '9.2 Grounding meditation.pdf', 'Grounding meditation.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(17, 16, 'meditation a complete guide from a to z', '9.3 Meditation with AOUM.pdf', 'Meditation with AOUM.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(19, 17, 'meditation a complete guide from a to z', '10. What next.pdf', 'What next.pdf', 'pdf', 2, '2016-08-06 04:01:30'),
	(20, 18, 'meditation a complete guide from a to z/guided meditations', 'Healing.mp3', 'Healing.mp3', 'mp3', 1, '2016-08-06 04:01:30'),
	(21, 18, 'meditation a complete guide from a to z/guided meditations', 'Higher Power.mp3', 'Higher Power.mp3', 'mp3', 1, '2016-08-06 04:01:30'),
	(22, 18, 'meditation a complete guide from a to z/guided meditations', 'Potential.mp3', 'Potential.mp3', 'mp3', 1, '2016-08-06 04:01:30'),
	(23, 18, 'meditation a complete guide from a to z/guided meditations', 'Quiet The Mind.mp3', 'Quiet The Mind.mp3', 'mp3', 1, '2016-08-06 04:01:30'),
	(24, 18, 'meditation a complete guide from a to z/guided meditations', 'Serenity.mp3', 'Serenity.mp3', 'mp3', 1, '2016-08-06 04:01:30'),
	(25, 1, 'meditation a complete guide from a to z', '1. Welcome.mp4', 'Welcome.mp4', 'mp4', 1, '2017-02-12 03:45:11'),
	(26, 2, 'meditation a complete guide from a to z', '2. Why meditation.mp4', 'Why meditation.mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(27, 3, 'meditation a complete guide from a to z', '3. Benefits of meditation.mp4', 'Benefits of meditation.mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(28, 4, 'meditation a complete guide from a to z', '4. Your practice diet.mp4', 'Your practice diet.mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(29, 5, 'meditation a complete guide from a to z', '5. Positions.mp4', 'Positions.mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(30, 6, 'meditation a complete guide from a to z', '7. Relaxation (Pratyahara).mp4', 'Relaxation (Pratyahara).mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(31, 7, 'meditation a complete guide from a to z', '6. Breathing (pranayama) theory.mp4', 'Breathing (pranayama) theory.mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(32, 8, 'meditation a complete guide from a to z', '6.1 Basic breathing exercise.mp4', 'Basic breathing exercise.mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(33, 9, 'meditation a complete guide from a to z', '6.2 Breathing-working with energy and nadi.mp4', 'Breathing-working with energy and nadi.mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(34, 10, 'meditation a complete guide from a to z', '6.3 Breathing - Grounding Technique.mp4', 'Breathing - Grounding Technique.mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(35, 11, 'meditation a complete guide from a to z', '8. Concentration.mp4', 'Concentration.mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(36, 12, 'meditation a complete guide from a to z', '8.1 Concentration Practice.mp4', 'Concentration Practice.mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(37, 13, 'meditation a complete guide from a to z', '9. Meditation theory.mp4', 'Meditation theory.mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(38, 14, 'meditation a complete guide from a to z', '9.1 Mindfulness Meditation.mp4', 'Mindfulness Meditation.mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(39, 15, 'meditation a complete guide from a to z', '9.2 A perfect inner balance.mp4', 'A perfect inner balance.mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(40, 16, 'meditation a complete guide from a to z', '9.3 Meditation with AOUM.mp4', '9.3 Meditation with AOUM.mp4', 'mp4', 1, '2016-08-06 04:01:30'),
	(41, 17, 'meditation a complete guide from a to z', '10. What next.mp4', 'What next.mp4', 'mp4', 1, '2016-08-06 04:01:30');
...
-- Dumping data for table membership.users_to_role: ~0 rows (approximately)
...
-- Dumping data for table membership.user_details: ~0 rows (approximately)
