...
-- Dumping data for table membership.logs: ~4 rows (approximately)
DELETE FROM `logs`;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='a table to track user logins and their details.\r\nContains token which is generated when user logs in, as well user agent (e.g browser) and his IP address';
